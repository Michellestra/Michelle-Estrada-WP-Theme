...
*/
function michelleestrada_theme_scripts() {
    wp_enqueue_style( 'michelleestrada', get_stylesheet_uri() );
}
add_action( 'wp_enqueue_scripts', 'michelleestrada_theme_scripts' );
...
// END STEP 2.9
    ...
    function add_my_menus() {
        register_nav_menus(
        array(
            'header-menu' => __( 'Header Menu', 'michelle-estrada' ),
            'footer-menu' => __( 'Footer Menu', 'michelle-estrada' ),
            'social-menu' => __( 'Social Menu', 'michelle-estrada'),
    ...
    function michelleestrada_theme_init(){
       ...
       // This feature adds RSS feed links to HTML <head>.
        ...
        add_action('after_setup_theme', 'michelleestrada_theme_init');
    ...
    function michelleestrada_widgets_init() {
    ...
    add_action( 'widgets_init', 'michelleestrada_widgets_init' );
